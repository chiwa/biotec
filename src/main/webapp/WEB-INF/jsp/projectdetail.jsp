...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>BIO TECH Project Detail</title>
		<!-- start: META -->
		<meta charset="utf-8" />
                                 ...
                                 <div class="panel-heading">
									...
									<div class="panel-tools">
										<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#add_project" onclick="">
										        <i class="fa fa-plus-square"> Add Process</i>
										</button>
									</div>
								</div>
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1"> <!-- id="sample_1" -->
										<thead>
											<tr>
												...
												<th class="center" style="width:30%;">Process Code</th>
												<th class="center" style="width:35%;">Process Name</th>
					    ...
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        <div class="modal-header">
					          ...
					          <h3 class="modal-title" style="color:#87B962">Add Process</h3>
					        </div>
					...
					<!-- ....................................... Modal ...........................................-->
                               <form role="form" class="form-horizontal">
                               	        <div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" placeholder="Process Name" id="form-field-1" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" placeholder="Process Code" id="form-field-2" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
										    <select id="form-field-select-3" class="form-control search-select">
												<option value="00">Process Type</option>
												<option value="01">Type A</option>
												<option value="02">Type B</option>
												<option value="03">Type C</option>
