...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>BIO TECH Project Detail Edit</title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" href="<c:url value="/plugins/bootstrap-fileupload/bootstrap-fileupload.min.css" />">
					...
					<ul class="main-navigation-menu">
						...
						<li>
							...
							<button style="background-color: #F6F6F6;border: 0;color: #87B962;padding-left: 20px;"
							   data-toggle="modal" data-target="#add_project" onclick="">
...
<!-- ............................................... Input .................................................-->
							<div class="panel panel-default">
                                 <div class="panel-heading">
									...
									<div class="panel-tools">
										<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#add_input" onclick="">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1"> <!-- id="sample_1" -->
										<thead>
											<tr>
												...
												<th class="center" style="width:50%;">Field</th>
												<th class="center" style="width:30%;">Type</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td class="center">
													...
													<a href="bio_tech_process_detail.html">
  ...
  <!-- ............................................... Output .................................................-->
							<div class="panel panel-default">
                                 <div class="panel-heading">
									Output
									<div class="panel-tools">
										<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#add_output" onclick="">
										        <i class="fa fa-plus-square"> Add</i>
										</button>
									</div>
								</div>
								...
								<div class="panel-body">
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2"> <!-- id="sample_1" -->
										<thead>
											<tr>
												<th class="center" style="width:20%;">Action</th>
												<th class="center" style="width:50%;">Field</th>
		                     ...
		                     <div class="panel panel-default">
					           <div class="panel-heading">
					           	  Script
					           	    <div class="panel-tools">
										<!-- <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#add_project" onclick="">
										        <i class="fa fa-plus-square"> Add Script</i>
										</button> -->

										<div data-provides="fileupload" class="fileupload fileupload-new"><input type="hidden">
													<span class="btn btn-file btn-success"><i class="fa fa-folder-open-o"></i> <span class="fileupload-new">Add Script</span><span class="fileupload-exists">Change</span>
														<input type="file">
													</span>
					           ...
					           <div class="panel-body">
				                    <div class="form-group">
										...
										<textarea placeholder="Default Text" id="form-field-22" rows="10"
										class="form-control">
							...
							<div >
										...
										<button type="button" class="btn btn-danger btn-md col-md-2 col-sm-2 col-xs-3" onclick="" style="margin-bottom:20px;float: right;">
													        Cancle
										</button>
										<button type="button" class="btn btn-success btn-md col-md-2 col-sm-2 col-xs-3" onclick="" style="margin-bottom:20px;margin-right:10px;float: right;">
													        Save
										</button>
						    </div>
							<!-- end: DYNAMIC TABLE PANEL -->
  ...
  <!-- ............................................... Output .................................................-->
					...
					</div> <!-- end div col-md-10 col-md-offset-1 -->

  <!-- ............................................... input ..................................................-->

					<div class="modal fade" id="add_input" role="dialog">
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        <div class="modal-header">
					          ...
					          <h3 class="modal-title" style="color:#87B962">INPUT</h3>
					        </div>
					        <div class="modal-body">
                               ...
                               <form role="form" class="form-horizontal">
                               	        <div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" placeholder="Field" id="form-field-1" class="form-control">
											</div>
										</div>
					        ...
					        <div class="modal-footer" style="background-color:#D6D6D6;">
					          <button type="button" class="btn btn-success col-md-2" style="float: right;margin-left: 10px;" data-dismiss="modal">Ok</button>
...
<!-- ............................................... output ..................................................-->
					...
					<div class="modal fade" id="add_output" role="dialog">
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h3 class="modal-title" style="color:#87B962">OUTPUT</h3>
					        </div>
					        <div class="modal-body">
